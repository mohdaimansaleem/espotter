...
function clicked() {
  ...
  if (sNumber.startsWith("50") || sNumber.startsWith("51") || sNumber.startsWith("52")) {
    if ((roomNumber >= 5001 && roomNumber <= 5008) || (roomNumber >= 5101 && roomNumber <= 5111) || (roomNumber >= 5201 && roomNumber <= 5211)) {
      sNumber = "1007"
    }
    //admin block
  }
